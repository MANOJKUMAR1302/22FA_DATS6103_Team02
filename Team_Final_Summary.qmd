...
Head and Summary of dataframe after removing NA Values, duplicates and outliers
```{python}
...
ANOVA Test for the salary of the job position per year
...
Results of the salary of the job position per year
```{python}
...
ANOVA Test on Software Engineering Manager Title
```{python}
...
Conclusion of Software Engineering Manager Title
```{python}
print("The p-value approach to hypothesis testing in the decision rule")
conclusion = "Failed to reject the null hypothesis."
...
ANOVA Test on Data Scientist Title
```{python}
...
DS_anova_table
```
Conclusion of Data Scientist Title
```{python}
print("The p-value approach to hypothesis testing in the decision rule")
conclusion = "Failed to reject the null hypothesis."
...
ANOVA Test on Product Manager title
```{python}
...
Conclusion of Prodcut Manager Title
```{python}
print("The p-value approach to hypothesis testing in the decision rule")
conclusion = "Failed to reject the null hypothesis."
...
ANOVA Test on Hardware Engineer Title
```{python}
...
HE_anova_table
```
Conclusion of Hardware Engineer Title
```{python}
print("The p-value approach to hypothesis testing in the decision rule")
conclusion = "Failed to reject the null hypothesis."
...
### Distribution of Top 10 companies and Not-top-10 companies
...
To find out whether the means for the two groups are equal or not. The result shows that the mean yearlysalary for top 10 companies is 212,371 USD, was significantly higher than the mean yearlysalary of not-top-10 companies, which is 179779 USD. Also, because the p-value < 0.05, we can conclude that the means for the two groups are not equal.
