...
# 6. Does work experience affect the salary of an employee? M will ask to his friend
...
'location_Santa Clara, CA','location_Palo Alto, CA','location_Chicago, IL','location_San Diego, CA','location_Toronto, ON, Canada','location_Bellevue, WA','location_Bengaluru, KA, India']]
...
print(R_Square_Score,Mean_Square_error)
```
