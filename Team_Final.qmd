...
print("The Training R Square value is: %2f"%lr_model.score(X_train,y_train))
print("The Testing R Square value is: %2f"%lr_model.score(X_test,y_test))
```
...
print("The Training R Square value is: %2f"%Reg_model.score(X_train,y_train))
print("The Testing R Square value is: %2f"%Reg_model.score(X_test,y_test))
```
