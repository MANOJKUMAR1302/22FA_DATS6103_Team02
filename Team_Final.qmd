...
df = old_df[['timestamp','company','title','location','yearsofexperience','yearsatcompany']]
...
# 3. Does work experience affect the salary of an employee? M will ask to his friend
...
# 4. Is working for more years in the same company affect the salary? B Done
...
# 5. In the recent five years, the average salary keeps the same? B Done
...
# How large is the wage disparity between men and women?
```{python}
